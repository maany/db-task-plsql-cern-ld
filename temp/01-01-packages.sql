create or replace package db_task_add_ons as
    -- A procedure to activate a setting
    procedure activate_setting(
...
create or replace package body db_task_add_ons as
    procedure activate_setting(
        i_parameter_id IN number,
        i_process_id IN number,
        i_setting_id IN number,
